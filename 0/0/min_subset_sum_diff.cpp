...
//s2= range-s1 and we have to minimize the (range-s1)-s1=range-2*s1 so from subset sum table i will take last row with true value (means subset exist for that value)
